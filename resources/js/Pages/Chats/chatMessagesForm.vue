...
<template>
    <form @submit.prevent="submit">
        <div class="flex gap-1 w-full h-full">
            ...
            />
            <PrimaryButton>
                <svg class="w-5 fill-gray-800" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512.001 512.001" xml:space="preserve">
                    <g>
                        <g>
